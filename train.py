...
if __name__ == '__main__':
  ...
  parser.add_argument( #采样率
      '--sample_rate',
      type=int,
      default=16000,
      help='Expected sample rate of the wavs',)
  parser.add_argument(
      '--clip_duration_ms', #音频长度 ms
      type=int,
      default=1000,
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='albert,appello,away_mode,call_carer,call_concierge,call_manager,call_reception,call_staff,'
              'cancel,care_line,clear_arming,close_live_view,close_monitor,disable_d_n_d,disable_mute,emergency,'
              'enable_d_n_d,enable_mute,express_delivery,face_recognition,help_me,home_mode,home_page,'
              'intruder_mode_off,night_mode,open_door,open_live_view,open_message,open_monitor,open_the_door,'
              'scan_q_r_code,shutdown,sleep_mode,smart_hub',
